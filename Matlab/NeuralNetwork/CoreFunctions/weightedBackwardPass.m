function [ grad, delta_k  ] = weightedBackwardPass( NN, DistWeights, Y, Hx, Weights, As, Sig_grads, ts, gc )
%WEIGHTEDBACKWARDPASS Summary of this function goes here
%   Detailed explanation goes here
    ...
    delta_k = (-1) * (Y - Hx) .* Hx .* (ones(size(Hx)) - Hx);       %Weighted Error signal gradient for outer layer
