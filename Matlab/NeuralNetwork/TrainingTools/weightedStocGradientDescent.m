function [ NN, E_Hist ] = weightedStocGradientDescent(maxIter, batchSize, DistWeights, costType, NN, Y, X, alpha, mew, lambda)
%WEIGHTEDSTOCGRADIENTDESCENT Summary of this function goes here
 ...
 nTraining = size(X,1);
    ...
    for i = 1:maxIter
        ...
        for j = 1:nBatches
            ...
            [ grad] = weightedBackwardPass( NN, DistWeights, Y(fst:lst,:), Hx, Weights, As, Sig_grads, ts, gradconst );
            fst = lst + 1;
